...
import parser.CommandParser.TASK_TYPE;
...
public class Parser {
	...
	private HashMap<String, CommandType> possibleCommandErrors = new HashMap<String, CommandType>();	
...
*/			default:
	...
	protected CommandType determineCommandType(String commandType) {
		...
		if(possibleCommandErrors.containsKey(commandType)) {
			return possibleCommandErrors.get(commandType);
		}
		else {
...
//		String[] str = userInput;
		...
		if (taskDescription.equals(userInput)) {
			setAsFloatingTask();
		}
